...
CompileState::CompileState(llvm::LLVMContext* c, llvm::Module* m, llvm::IRBuilder<>* ir, llvm::DIBuilder* di)
{
    ...
    alloc_console_ = llvm::Function::Create(alloc_console_type_, llvm::GlobalValue::LinkageTypes::ExternalLinkage, "AllocConsole", module_);
    ...
    attach_console_ = llvm::Function::Create(attach_console_type_, llvm::GlobalValue::LinkageTypes::ExternalLinkage, "AttachConsole", module_);

	// native: FreeConsole (Kernel32)
	free_console_type_ = llvm::FunctionType::get(llvm::Type::getInt1Ty(*context_), false);
    free_console_ = llvm::Function::Create(free_console_type_, llvm::GlobalValue::LinkageTypes::ExternalLinkage, "FreeConsole", module_);
    ...
    get_std_handle_ = llvm::Function::Create(get_std_handle_type_, llvm::GlobalValue::LinkageTypes::ExternalLinkage, "GetStdHandle", module_);

	// native: WriteFile (Kernel32)
	llvm::Type* writeFile_params[] = {llvm::Type::getInt8PtrTy(*context_), llvm::Type::getInt8PtrTy(*context_), llvm::Type::getInt32Ty(*context_), llvm::Type::getInt32PtrTy(*context_), llvm::Type::getInt8PtrTy(*context_) };
    write_file_type_ = llvm::FunctionType::get(llvm::Type::getInt1Ty(*context_), writeFile_params, false);
    write_file_ = llvm::Function::Create(write_file_type_, llvm::GlobalValue::LinkageTypes::ExternalLinkage, "WriteFile", module_);
    ...
    exit_process_ = llvm::Function::Create(exit_process_type_, llvm::GlobalValue::LinkageTypes::ExternalLinkage, "ExitProcess", module_);
}
