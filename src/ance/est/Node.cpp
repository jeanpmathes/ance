...
ance::est::ArrayTypeConstructor::ArrayTypeConstructor(utility::Owned<Expression> type, utility::Owned<Expression> length_expression, core::Location const& source_location)
    : Node(source_location)
    , Expression()
