...
class Type
{
	...
	public:
		...
		virtual void buildSetIndexer(ance::Value* indexed, ance::Value* index, ance::Value* assigned, llvm::LLVMContext& c, llvm::Module* m, CompileState* state, llvm::IRBuilder<>& ir, llvm::DIBuilder* di);
