...
namespace ance::ast
{
    ...
    struct File final : Node, utility::ConcreteNode<File, Visitor>
    {
        File(
            utility::List<utility::Owned<Declaration>> declaration_list,
    ...
    struct ErrorDeclaration final : Declaration,
    ...
    struct RunnableDeclaration final : Declaration,
    ...
    struct Block final : Statement, utility::ConcreteNode<Block, Visitor>
    {
        Block(
            utility::List<utility::Owned<Statement>> statement_list,
            core::Location const&                    source_location
        );
    ...
    struct Independent final : Statement, utility::ConcreteNode<Independent, Visitor>
    {
        Independent(
            utility::Owned<Expression> independent_expression,
            core::Location const&      source_location
        );
    ...
    struct Bind final : Statement, utility::ConcreteNode<Bind, Visitor>
    {
        Bind(
            core::Identifier const&                       name,
    ...
    struct Assignment final : Statement, utility::ConcreteNode<Assignment, Visitor>
    {
        Assignment(
    ...
    struct If final : Statement, utility::ConcreteNode<If, Visitor>
    {
    ...
    struct Loop final : Statement, utility::ConcreteNode<Loop, Visitor>
    {
    ...
    struct While final : Statement, utility::ConcreteNode<While, Visitor>
    {
        While(
            utility::Owned<Expression> expression,
            utility::Owned<Statement>  statement,
    ...
    struct Match final : Statement, utility::ConcreteNode<Match, Visitor>
    {
        Match(
            utility::Owned<Expression>               expression,
            utility::List<utility::Owned<MatchCase>> case_list,
            core::Location const&                    source_location
        );
    ...
    struct Erase final : Statement, utility::ConcreteNode<Erase, Visitor>
    {
    ...
    struct Expression : virtual Node, virtual utility::AbstractNode<Visitor>
    {
    };
    ...
    struct And final : Expression, utility::ConcreteNode<And, Visitor>
    {
        And(utility::Owned<Expression> lhs,
            bool                       neg,
    ...
    struct Or final : Expression, utility::ConcreteNode<Or, Visitor>
    {
        Or(utility::Owned<Expression> lhs,
           bool                       neg,
           utility::Owned<Expression> rhs,
           core::Location const&      source_location);
    ...
    struct Call final : Expression, utility::ConcreteNode<Call, Visitor>
    {
        Call(
    ...
    struct Subscript final : Expression, utility::ConcreteNode<Subscript, Visitor>
    {
        Subscript(
            utility::Owned<Expression> indexed_value,
            utility::Owned<Expression> index_value,
            core::Location const&      source_location
        );
    ...
    struct Lambda final : Expression, utility::ConcreteNode<Lambda, Visitor>
    {
        Lambda(
            utility::List<Parameter>                      params,
            utility::Optional<utility::Owned<Expression>> type,
    ...
    struct Access final : Expression, utility::ConcreteNode<Access, Visitor>
    {
    ...
    struct UnitLiteral final : Expression, utility::ConcreteNode<UnitLiteral, Visitor>
    {
        explicit UnitLiteral(core::Location const& source_location);
    };

    /// A literal for a value of the size type.
    struct SizeLiteral final : Expression, utility::ConcreteNode<SizeLiteral, Visitor>
    {
    ...
    struct StringLiteral final : Expression, utility::ConcreteNode<StringLiteral, Visitor>
    {
    ...
    struct BoolLiteral final : Expression, utility::ConcreteNode<BoolLiteral, Visitor>
    {
    ...
    struct Intrinsic final : Expression, utility::ConcreteNode<Intrinsic, Visitor>
    {
        Intrinsic(
            utility::Owned<Expression>                intrinsic_name,
          ...
          utility::ConcreteNode<ArrayTypeConstructor, Visitor>
    {
        ArrayTypeConstructor(
            utility::Owned<Expression> type,
            utility::Owned<Expression> length_expression,
            core::Location const&      source_location
        );
    ...
    struct BlockExpression final : Expression,
    ...
    struct Parenthesis final : Expression, utility::ConcreteNode<Parenthesis, Visitor>
    {
        Parenthesis(
            utility::Owned<Expression> expression,
            core::Location const&      source_location
    ...
    struct Here final : Expression, utility::ConcreteNode<Here, Visitor>
    {
    ...
    struct IfExpression final : Expression, utility::ConcreteNode<IfExpression, Visitor>
    {
        IfExpression(
            utility::Owned<Expression> expression,
    ...
    struct MatchCase final : Auxiliary, utility::ConcreteNode<MatchCase, Visitor>
    {
        MatchCase(
            utility::List<utility::Owned<Expression>> pattern_list,
        ...
        core::Location
            default_pattern_location; // todo: make default a pattern with an actual node, then no special field is needed
        utility::Owned<Statement> body;
    };

    /// A case of a match expression. Has a set of patterns, or no patterns if it is the default case.
    struct MatchExpressionCase final : Auxiliary,
