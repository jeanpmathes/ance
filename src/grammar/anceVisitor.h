...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitDelete_statement(anceParser::Delete_statementContext *context) = 0;
    ...
    virtual antlrcpp::Any visitAllocation_expression(anceParser::Allocation_expressionContext *context) = 0;
