...
class anceParser : public antlr4::Parser
{
  public:
    ...
    enum
    {
        ...
        RuleGlobal                       = 2,
        RuleDescription                  = 3,
        RuleVariableDescription          = 4,
        RuleFunctionDescription          = 5,
        RuleFunctionBlock                = 6,
        RuleParameters                   = 7,
        RuleParameter                    = 8,
        RuleTypeDescription              = 9,
        RuleAliasDescription             = 10,
        RuleStructDescription            = 11,
        RuleMember                       = 12,
        RuleAccessModifier               = 13,
        RuleCode                         = 14,
        RuleBlock                        = 15,
        RuleStatement                    = 16,
        RuleExpressionStatement          = 17,
        RuleLocalVariableDefinition      = 18,
        RuleLocalReferenceDefinition     = 19,
        RuleEraseStatement               = 20,
        RuleAssignment                   = 21,
        RuleAssigner                     = 22,
        RuleDeleteStatement              = 23,
        RuleBreakStatement               = 24,
        RuleContinueStatement            = 25,
        RuleReturnStatement              = 26,
        RuleAssertStatement              = 27,
        RuleIfStatement                  = 28,
        RuleWhileStatement               = 29,
        RuleLoopStatement                = 30,
        RuleMatchStatement               = 31,
        RuleMatchCase                    = 32,
        RuleExpression                   = 33,
        RuleUnaryOperator                = 34,
        RuleBinaryOperatorMultiplicative = 35,
        RuleBinaryOperatorAdditive       = 36,
        RuleBinaryOperatorBitwise        = 37,
        RuleBinaryOperatorShift          = 38,
        RuleBinaryOperatorRelational     = 39,
        RuleBinaryOperatorEquality       = 40,
        RuleIndependentExpression        = 41,
        RuleFunctionCall                 = 42,
        RuleArguments                    = 43,
        RuleVariableAccess               = 44,
        RuleAllocation                   = 45,
        RuleAllocator                    = 46,
        RuleAddressof                    = 47,
        RuleBindRef                      = 48,
        RuleSizeofType                   = 49,
        RuleSizeofExpression             = 50,
        RuleMatchExpression              = 51,
        RuleMatchExpressionCase          = 52,
        RuleLiteralExpression            = 53,
        RuleStringLiteral                = 54,
        RuleCharLiteral                  = 55,
        RuleIntegerLiteral               = 56,
        RuleNormalInteger                = 57,
        RuleSpecialInteger               = 58,
        RuleFloatingPointLiteral         = 59,
        RuleBooleanLiteral               = 60,
        RuleNullLiteral                  = 61,
        RuleSizeLiteral                  = 62,
        RuleDiffLiteral                  = 63,
        RuleUiptrLiteral                 = 64,
        ...
        RuleVectorType                   = 69,
        RuleKeywordType                  = 70,
        RuleFloatingPointType            = 71,
        RuleTargetDependentType          = 72,
        RuleBooleanType                  = 73,
        RuleCharType                     = 74,
        RuleNullPointerType              = 75,
        RuleUnitType                     = 76,
        RuleCustomType                   = 77
    };
