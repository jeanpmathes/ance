...
public:
  enum {
    ...
    STRING_PREFIX = 43, STRING = 44, BYTE = 45, INTEGER = 46, BUFFER = 47, 
    CONST = 48, IDENTIFIER = 49, WHITESPACE = 50, BLOCK_COMMENT = 51, LINE_COMMENT = 52
  };

  enum {
    RuleFile = 0, RuleData = 1, RuleVariableDeclaration = 2, RuleCode = 3, 
    RuleFunction = 4, RuleParameters = 5, RuleParameter = 6, RuleAccessModifier = 7, 
    RuleStatement = 8, RuleExpressionStatement = 9, RuleLocalVariableDefinition = 10, 
    RuleAssignment = 11, RuleAssigner = 12, RuleDeleteStatement = 13, RuleReturnStatement = 14, 
    RuleAssignable = 15, RuleVariableAssignable = 16, RuleIndexerSet = 17, 
    RuleDiscard = 18, RuleExpression = 19, RuleIndependentExpression = 20, 
    RuleFunctionCall = 21, RuleArguments = 22, RuleVariableAccess = 23, 
    RuleAllocation = 24, RuleAllocator = 25, RuleRoughCast = 26, RuleSizeofType = 27, 
    RuleSizeofExpression = 28, RuleLiteralExpression = 29, RuleStringLiteral = 30, 
    RuleByteLiteral = 31, RuleIntegerLiteral = 32, RuleUnsignedInteger = 33, 
    RuleSignedInteger = 34, RuleSpecialInteger = 35, RuleFloatingPointLiteral = 36, 
    RuleBooleanLiteral = 37, RuleSizeLiteral = 38, RuleType = 39, RuleIntegerType = 40, 
    RuleArrayType = 41, RuleKeywordType = 42, RuleFloatingPointType = 43, 
    RuleSizeType = 44, RuleUnsignedIntegerPointerType = 45, RuleVoidType = 46
  };
