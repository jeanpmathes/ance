...
anceParser::FileContext* anceParser::file()
{
    ...
    try
    {
        ...
        _la = _input->LA(1);
        while ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__6) | (1ULL << anceParser::T__8) | (1ULL << anceParser::T__9))) != 0))
        {
            setState(98);
            _errHandler->sync(this);
...
anceParser::VariableDeclarationContext* anceParser::variableDeclaration()
{
    ...
    try
    {
        ...
        _la = _input->LA(1);
        if ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__10) | (1ULL << anceParser::T__11) | (1ULL << anceParser::T__12))) != 0))
        {
            setState(118);
            assigner();
            setState(119);
    ...
    try
    {
        ...
        switch (_input->LA(1))
        {
            ...
            case anceParser::T__9: {
                ...
                _errHandler->sync(this);
                _la = _input->LA(1);
                while ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__4) | (1ULL << anceParser::T__13) | (1ULL << anceParser::T__14) | (1ULL << anceParser::T__15) | (1ULL << anceParser::T__17) | (1ULL << anceParser::T__18) | (1ULL << anceParser::T__21) | (1ULL << anceParser::T__23) | (1ULL << anceParser::T__24) | (1ULL << anceParser::T__25) | (1ULL << anceParser::T__27) | (1ULL << anceParser::T__28) | (1ULL << anceParser::T__29) | (1ULL << anceParser::T__30) | (1ULL << anceParser::T__31) | (1ULL << anceParser::T__32) | (1ULL << anceParser::NATIVE_INTEGER_TYPE) | (1ULL << anceParser::SIGNED_INTEGER) | (1ULL << anceParser::HEX_INTEGER) | (1ULL << anceParser::BIN_INTEGER) | (1ULL << anceParser::OCT_INTEGER) | (1ULL << anceParser::HALF) | (1ULL << anceParser::SINGLE) | (1ULL << anceParser::DOUBLE) | (1ULL << anceParser::QUAD) | (1ULL << anceParser::STRING_PREFIX) | (1ULL << anceParser::STRING) | (1ULL << anceParser::BYTE) | (1ULL << anceParser::INTEGER) | (1ULL << anceParser::IDENTIFIER))) != 0))
                {
                    setState(134);
                    statement();
                    setState(139);
...
anceParser::ParametersContext* anceParser::parameters()
{
    ...
    try
    {
        ...
        _la = _input->LA(1);
        if ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__15) | (1ULL << anceParser::T__25) | (1ULL << anceParser::T__27) | (1ULL << anceParser::T__28) | (1ULL << anceParser::T__29) | (1ULL << anceParser::T__30) | (1ULL << anceParser::T__31) | (1ULL << anceParser::T__32) | (1ULL << anceParser::NATIVE_INTEGER_TYPE))) != 0))
        {
            setState(152);
            parameter();
            setState(157);
...
anceParser::ReturnStatementContext* anceParser::returnStatement()
{
    ...
    try
    {
        ...
        _la = _input->LA(1);
        if ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__4) | (1ULL << anceParser::T__18) | (1ULL << anceParser::T__21) | (1ULL << anceParser::T__23) | (1ULL << anceParser::T__24) | (1ULL << anceParser::SIGNED_INTEGER) | (1ULL << anceParser::HEX_INTEGER) | (1ULL << anceParser::BIN_INTEGER) | (1ULL << anceParser::OCT_INTEGER) | (1ULL << anceParser::HALF) | (1ULL << anceParser::SINGLE) | (1ULL << anceParser::DOUBLE) | (1ULL << anceParser::QUAD) | (1ULL << anceParser::STRING_PREFIX) | (1ULL << anceParser::STRING) | (1ULL << anceParser::BYTE) | (1ULL << anceParser::INTEGER) | (1ULL << anceParser::IDENTIFIER))) != 0))
        {
            setState(206);
            expression(0);
        }
...
anceParser::FloatingPointLiteralContext* anceParser::floatingPointLiteral()
{
    ...
    try
    {
        ...
        setState(337);
        _la = _input->LA(1);
        if (!((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::HALF) | (1ULL << anceParser::SINGLE) | (1ULL << anceParser::DOUBLE) | (1ULL << anceParser::QUAD))) != 0)))
        {
...
anceParser::FloatingPointTypeContext* anceParser::floatingPointType()
{
    ...
    try
    {
        ...
        setState(374);
        _la = _input->LA(1);
        if (!((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__27) | (1ULL << anceParser::T__28) | (1ULL << anceParser::T__29) | (1ULL << anceParser::T__30))) != 0)))
        {
            _errHandler->recoverInline(this);
        }
        else
