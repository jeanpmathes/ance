...
anceParser::FileContext* anceParser::file()
{
    ...
    try
    {
        ...
        _la = _input->LA(1);
        while ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__5) | (1ULL << anceParser::T__7) | (1ULL << anceParser::T__8))) != 0))
        {
            setState(96);
            _errHandler->sync(this);
...
anceParser::VariableDeclarationContext* anceParser::variableDeclaration()
{
    ...
    try
    {
        ...
        _la = _input->LA(1);
        if ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__9) | (1ULL << anceParser::T__10) | (1ULL << anceParser::T__11))) != 0))
        {
            setState(109);
            assigner();
            setState(110);
    ...
    try
    {
        ...
        switch (_input->LA(1))
        {
            ...
            case anceParser::T__8: {
                ...
                _errHandler->sync(this);
                _la = _input->LA(1);
                while ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__3) | (1ULL << anceParser::T__12) | (1ULL << anceParser::T__13) | (1ULL << anceParser::T__14) | (1ULL << anceParser::T__16) | (1ULL << anceParser::T__17) | (1ULL << anceParser::T__20) | (1ULL << anceParser::T__22) | (1ULL << anceParser::T__23) | (1ULL << anceParser::T__24) | (1ULL << anceParser::T__26) | (1ULL << anceParser::T__27) | (1ULL << anceParser::T__28) | (1ULL << anceParser::T__29) | (1ULL << anceParser::T__30) | (1ULL << anceParser::T__31) | (1ULL << anceParser::NATIVE_INTEGER_TYPE) | (1ULL << anceParser::SIGNED_INTEGER) | (1ULL << anceParser::HEX_INTEGER) | (1ULL << anceParser::BIN_INTEGER) | (1ULL << anceParser::OCT_INTEGER) | (1ULL << anceParser::HALF) | (1ULL << anceParser::SINGLE) | (1ULL << anceParser::DOUBLE) | (1ULL << anceParser::QUAD) | (1ULL << anceParser::STRING_PREFIX) | (1ULL << anceParser::STRING) | (1ULL << anceParser::BYTE) | (1ULL << anceParser::INTEGER) | (1ULL << anceParser::IDENTIFIER))) != 0))
                {
                    setState(125);
                    statement();
                    setState(130);
...
anceParser::ParametersContext* anceParser::parameters()
{
    ...
    try
    {
        ...
        _la = _input->LA(1);
        if ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__14) | (1ULL << anceParser::T__24) | (1ULL << anceParser::T__26) | (1ULL << anceParser::T__27) | (1ULL << anceParser::T__28) | (1ULL << anceParser::T__29) | (1ULL << anceParser::T__30) | (1ULL << anceParser::T__31) | (1ULL << anceParser::NATIVE_INTEGER_TYPE))) != 0))
        {
            setState(143);
            parameter();
            setState(148);
...
anceParser::ReturnStatementContext* anceParser::returnStatement()
{
    ...
    try
    {
        ...
        _la = _input->LA(1);
        if ((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__3) | (1ULL << anceParser::T__17) | (1ULL << anceParser::T__20) | (1ULL << anceParser::T__22) | (1ULL << anceParser::T__23) | (1ULL << anceParser::SIGNED_INTEGER) | (1ULL << anceParser::HEX_INTEGER) | (1ULL << anceParser::BIN_INTEGER) | (1ULL << anceParser::OCT_INTEGER) | (1ULL << anceParser::HALF) | (1ULL << anceParser::SINGLE) | (1ULL << anceParser::DOUBLE) | (1ULL << anceParser::QUAD) | (1ULL << anceParser::STRING_PREFIX) | (1ULL << anceParser::STRING) | (1ULL << anceParser::BYTE) | (1ULL << anceParser::INTEGER) | (1ULL << anceParser::IDENTIFIER))) != 0))
        {
            setState(197);
            expression(0);
        }
...
anceParser::FloatingPointTypeContext* anceParser::floatingPointType()
{
    ...
    try
    {
        ...
        setState(365);
        _la = _input->LA(1);
        if (!((((_la & ~0x3fULL) == 0) && ((1ULL << _la) & ((1ULL << anceParser::T__26) | (1ULL << anceParser::T__27) | (1ULL << anceParser::T__28) | (1ULL << anceParser::T__29))) != 0)))
        {
            _errHandler->recoverInline(this);
        }
        else
