...
class anceBaseVisitor : public anceVisitor
{
  public:
    ...
    virtual std::any visitProjectFile(anceParser::ProjectFileContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitGlobal(anceParser::GlobalContext* ctx) override { return visitChildren(ctx); }

    virtual std::any visitDescription(anceParser::DescriptionContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitFunctionBlock(anceParser::FunctionBlockContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitExtern(anceParser::ExternContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitEraseStatement(anceParser::EraseStatementContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitLoopStatement(anceParser::LoopStatementContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitCast(anceParser::CastContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitUnitLiteral(anceParser::UnitLiteralContext* ctx) override { return visitChildren(ctx); }
    ...
    virtual std::any visitUnitType(anceParser::UnitTypeContext* ctx) override { return visitChildren(ctx); }
